...
def print_startup_info(app):
    ...
    api_name = app.config.get('API_NAME', 'Dokemon API')
    port = app.config.get('PORT', 9090)
    print("Starting {} on port {}...".format(api_name, port))
    ...
    print("API Documentation available at: http://localhost:{}/".format(port))
    ...
    print("\n[DATABASE] Database: SQLite at data/dokemon.db (auto-created)")
